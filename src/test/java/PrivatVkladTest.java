...
public class PrivatVkladTest extends BeforeAfter{
    ...
    public void testVklad(){
        ...
        WebElement button = driver.findElement(By.id("button_DPR0_12_usd"));
        ...
        WebElement text = driver.findElement(By.id("form_DPR0_12_usd")).findElement(By.tagName("h3"));
        ...
        WebElement telephone = driver.findElement(By.id("phone_DPR0_12_usd"));
